...
function Home() {
  ...
  return (
    <div className='min-h-screen bg-[#921BFA] flex flex-col'>
      <Navbar />
      ...
      <div className='flex-1 px-6 py-20'>
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='flex justify-center mb-6'>
            <div className='bg-[#1D162F] text-pink-400 text-sm px-4 py-2 rounded-full flex items-center gap-2'>
          ...
          <div className='text-center mb-28'>
            <motion.h1
              ...
              <span className='relative inline-block mt-5'>
                <span className=' text-[#9cf70a] bg-[#221f2c]  px-5 py-1 rounded-full '>
                  AI Intelligence
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [
                ...
                <motion.div key={index}
                  ...
                  className={`
        relative bg-[#052f4a] rounded-3xl border-2 border-green-100 
      ...
      `}>
                  ...
                  <div className='absolute -top-8 left-1/2 -translate-x-1/2 bg-gray-200 border-2 border-green-500 text-green-600 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg'>
                    {item.icon}</div>
                  <div className='pt-10 text-center'>
                    <div className='text-xs text-red-400 font-semibold mb-2 tracking-wider'>{item.step}</div>
          ...
          <div className='mb-32'>
            <motion.h2
              ...
              Advanced AI{" "}
              <span className="text-[#a6eb39]">Capabilities</span>
